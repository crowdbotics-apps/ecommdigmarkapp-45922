"""
Django settings for ecommdigmarkapp_45922 project.
...
ROOT_URLCONF = 'ecommdigmarkapp_45922.urls'
...
WSGI_APPLICATION = 'ecommdigmarkapp_45922.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ecommdigmarkapp_45922 API",
    "DESCRIPTION": "API documentation for ecommdigmarkapp_45922 App",
    "VERSION": "v1",
}
